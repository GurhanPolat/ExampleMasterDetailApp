		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ExampleMasterDetailApp",
									"targetURL": "#ExampleMasterDetailApp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ExampleMasterDetailApp-display": {
								"semanticObject": "ExampleMasterDetailApp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapui5.ExampleMasterDetailApp",
									"url": sap.ui.require.toUrl("sapui5/ExampleMasterDetailApp")
								}
							}
						}
					}
