...
sap.ui.define([
	...
	return BaseController.extend("sapui5.ExampleMasterDetailApp.controller.Detail", {
		...
		_filterTable: function (sPonumber) {

			debugger;

			var oFilter = new Filter("Ponumber", FilterOperator.EQ, sPonumber);
